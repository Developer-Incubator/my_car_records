            ...
            children: [
              CupertinoListSection.insetGrouped(
                ...
                children: [
                  ...
                  InfoItem(name: "Top Speed (MPH)", info: vehicle.topSpeedMPH),
                  ...
                  InfoItem(
                      name: "Keyless Ignition", info: vehicle.keylessIgnition),
                  ...
                  InfoItem(name: "Model Year", info: vehicle.modelYear),
                ],
              ),
              CupertinoListSection.insetGrouped(
                dividerMargin: -10,
                ...
                children: [
                  ...
                  InfoItem(
                      name: "Displacement (CC)", info: vehicle.displacementCC),
                  InfoItem(
                      name: "Displacement (CI)", info: vehicle.displacementCI),
                  InfoItem(
                      name: "Displacement (L)", info: vehicle.displacementL),
                  InfoItem(
                      name: "Configuration", info: vehicle.engineConfiguration),
              ...
              CupertinoListSection.insetGrouped(
                ...
                children: [
                  ...
                  InfoItem(
                      name: "Charger Power (KW)", info: vehicle.chargerPowerKW),
              ...
              CupertinoListSection.insetGrouped(
                ...
                children: [
                  ...
                  InfoItem(name: "Seat Belts All", info: vehicle.pretensioner),
                  InfoItem(
                      name: "Rear Automatic Emergency Braking",
              ...
              CupertinoListSection.insetGrouped(
                ...
                children: [
                  ...
                  InfoItem(
                      name: "Brake System Type", info: vehicle.brakeSystemType),
                ],
              ),
              CupertinoListSection.insetGrouped(
                dividerMargin: -10,
                ...
                children: [
                  ...
                  InfoItem(name: "Bed Length (in)", info: vehicle.bedLengthIN),
                  ...
                  InfoItem(
                      name: "Cach for Clunkers", info: vehicle.cashForClunkers),
                  InfoItem(
                  ...
                  InfoItem(name: "NCSA Body Type", info: vehicle.ncsaBodyType),
                  ...
                  InfoItem(name: "Other Bus Info", info: vehicle.otherBusInfo),
                ],
              ),
              ...
              InfoItem(
                  name: "Other Engine Info", info: vehicle.otherEngineInfo),
              InfoItem(
              ...
              InfoItem(
                  name: "Other Trailer Info", info: vehicle.otherTrailerInfo),
              ...
              InfoItem(
                  name: "Plant Company Name", info: vehicle.plantCompanyName),
              InfoItem(name: "Plant Country", info: vehicle.plantCountry),
              InfoItem(name: "Park State", info: vehicle.plantState),
              InfoItem(name: "Possible Value", info: vehicle.possibleValues),
              ...
              InfoItem(name: "Traction Control", info: vehicle.tractionControl),
              InfoItem(
                  name: "Trailer Body Type", info: vehicle.trailerBodyType),
              InfoItem(name: "Trailer Length", info: vehicle.trailerLength),
              InfoItem(name: "Trailer Type", info: vehicle.trailerType),
              InfoItem(
                  name: "Trainsmission Speeds",
                  info: vehicle.transmissionSpeeds),
              InfoItem(
                  name: "Transmission Style", info: vehicle.transmissionStyle),

              InfoItem(
                  name: "Vehicle Descriptor", info: vehicle.vehicleDescriptor),

              InfoItem(name: "Wheel Base Long", info: vehicle.wheelBaseLong),
              InfoItem(name: "Wheel Base Short", info: vehicle.wheelBaseShort),
              InfoItem(name: "Wheel Size Front", info: vehicle.wheelSizeFront),
              InfoItem(name: "Wheel Size Rear", info: vehicle.wheelSizeRear),
